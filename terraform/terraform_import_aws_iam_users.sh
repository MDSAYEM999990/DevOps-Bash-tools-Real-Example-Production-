AWS কনসোলে গিয়ে মাউস ক্লিক করে আইএএম ইউজার তৈরি করা খুব সহজ, কিন্তু যখন আপনার কোম্পানিতে ইউজারের সংখ্যা ৫০ বা ১০০ ছাড়িয়ে যায়, তখন কার কোন 
পারমিশন আছে তা ট্র্যাক করা কঠিন হয়ে পড়ে। তাই স্ট্যান্ডার্ড প্র্যাকটিস হলো সব
ইউজারকে Terraform কোড দিয়ে ম্যানেজ করা।
