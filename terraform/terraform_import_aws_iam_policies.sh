...
আপনার AWS অ্যাকাউন্টে হয়তো আগে থেকেই কিছু আইএএম পলিসি (IAM Policy) তৈরি করা আছে। আপনি এখন সেগুলোকে কোডের মাধ্যমে ম্যানেজ করতে চান। 
এই স্ক্রিপ্টটি স্বয়ংক্রিয়ভাবে terraform plan এবং AWS API কম্বাইন করে সেই পুরোনো পলিসিগুলোর ARN (Amazon Resource Name) খুঁজে বের
করে এবং সেগুলোকে Terraform State-এ ইম্পোর্ট করে দেয়।
#!/usr/bin/env bash
