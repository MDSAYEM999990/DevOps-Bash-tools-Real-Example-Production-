ধরুন, আপনার কোম্পানিতে আগে থেকেই GitHub-এ ২০টি টিম ম্যানুয়ালি তৈরি করা ছিল। এখন আপনি সিদ্ধান্ত নিয়েছেন যে সব টিম এখন থেকে Terraform কোডের মাধ্যমে ম্যানেজ করবেন (Infrastructure as Code)।

আপনি যদি এখন terraform apply রান করেন, তবে Terraform ওই পুরোনো টিমগুলোকে চিনতে পারবে না। সে ভাববে এগুলো একদম নতুন টিম এবং GitHub API-তে গিয়ে আবার নতুন করে তৈরি করার চেষ্টা করবে। তখন GitHub এরর দেখাবে যে—"এই নামের টিম তো অলরেডি আছে!"

সমাধান (এই স্ক্রিপ্টের কাজ):
এই সমস্যা দূর করতে Terraform-এর একটি কমান্ড আছে: terraform import। কিন্তু ২০টি টিমের জন্য আলাদা করে আইডি খুঁজে বের করে ২০ বার কমান্ড চালানো কষ্টের। এই স্ক্রিপ্টটি আপনার পুরো কোড স্ক্যান করে স্বয়ংক্রিয়ভাবে বুলেটের গতিতে সব পুরোনো টিমকে একবারে Terraform-এর স্টেটে ইম্পোর্ট করে দেয়।
#!/usr/bin/env bash
