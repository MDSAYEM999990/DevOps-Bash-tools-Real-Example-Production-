...
Terraform Cloud নিয়মিত তাদের আইপি অ্যাড্রেস আপডেট করে। আপনার ফায়ারওয়াল যদি পুরনো আইপি ধরে বসে থাকে, তবে নতুন কোনো ইনফ্রাস্ট্রাকচার তৈরি হবে না (সার্ভার ভেঙে যাবে)।
সমাধান: এই স্ক্রিপ্টটি প্রতিদিন সিডিউল করা থাকে। এটি নতুন আইপি লিস্ট ফেচ করে এবং স্বয়ংক্রিয়ভাবে কোম্পানির ফায়ারওয়াল রুল আপডেট করে দেয়। এতে মানুষ ভুল করার সুযোগ পায় না।
More details....  https://mega.nz/file/kuhxybTJ#42apRXzhFnEkvVc6i8RAwgYfUR5e14wQwlhfE_6VhQU
