...
ধরুন, আপনার কোম্পানিতে AWS ক্লাউড ব্যবহার করা হয়। আপনি Terraform Cloud-এর মাধ্যমে AWS-এ ইনফ্রাস্ট্রাকচার তৈরি করবেন। এর জন্য Terraform-এর AWS_ACCESS_KEY_ID এবং AWS_SECRET_ACCESS_KEY নামক দুটি সিক্রেট কোড প্রয়োজন।

সমস্যা:
সাধারণত আপনাকে Terraform Cloud-এর ওয়েবসাইটে গিয়ে, নির্দিষ্ট ওয়ার্কস্পেস খুঁজে, "Variables" অপশনে ক্লিক করে একে একে এই সিক্রেটগুলো টাইপ করে সেভ করতে হয়। এই কাজটি যদি আপনার ৫০টি ওয়ার্কস্পেসের জন্য করা লাগে, তবে তা অত্যন্ত ক্লান্তিকর এবং ভুল হওয়ার সম্ভাবনা থাকে। তাছাড়া, এই সিক্রেটগুলো প্রতি মাসে পরিবর্তন (Rotate) করতে হলে ঝামেলা আরও বাড়ে।

সমাধান (এই স্ক্রিপ্টের কাজ):
এই স্ক্রিপ্টটি ব্যবহার করে আপনি আপনার কম্পিউটার থেকে মাত্র একটি কমান্ড দিয়েই সেই সিক্রেটগুলো এক সেকেন্ডে Terraform Cloud-এ পাঠিয়ে দিতে পারেন।
